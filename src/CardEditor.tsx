...
import { CardEditorFragment$key } from "./__generated__/CardEditorFragment.graphql.ts";

const CardEditorFragment = graphql`
...
export const CardEditor = ({ card }: { card: CardEditorFragment$key }) => {
  const data = useFragment<CardEditorFragment$key>(CardEditorFragment, card);
